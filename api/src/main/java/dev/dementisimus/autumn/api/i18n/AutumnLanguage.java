...
import dev.dementisimus.autumn.api.storage.type.sql.SQLTypes;
...
public enum AutumnLanguage {
    ...
    private final int selectionInventorySlot;
     ...
     * @since 1.0.0
     */
    public static @Nullable AutumnLanguage fromLocale(Locale locale) {
