...
package dev.dementisimus.autumn.api.factory.inventory;
...
public interface InventoryFactory {
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory contents(ItemStack[] itemStacks);
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory item(int slot, ItemFactory itemFactory);
     ...
     * @since 1.1.1
     */
    @NotNull InventoryFactory item(ItemFactory itemFactory, int... slots);
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory item(int slot, ItemStack itemStack);
     ...
     * @since 1.1.1
     */
    @NotNull InventoryFactory item(ItemStack itemStack, int... slots);
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory items(ItemStack... itemStacks);
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory placeholder(Material placeholder);
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory placeholder(Material placeholder, int... slots);
     ...
     * @since 1.1.1
     */
    @NotNull InventoryFactory placeholderBorder(Material placeholder);
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory storageContents(ItemStack[] itemStacks);
     ...
     * @since 1.0.0
     */
    @NotNull InventoryFactory itemOrPlaceholder(int slot, @Nullable ItemStack itemStack, Material placeholder);
     ...
     * @since 1.1.1
     */
    void createFor(AutumnTaskExecutor taskExecutor, Player player);
}
