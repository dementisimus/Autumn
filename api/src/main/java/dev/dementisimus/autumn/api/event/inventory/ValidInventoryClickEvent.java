...
package dev.dementisimus.autumn.api.event.inventory;
...
public class ValidInventoryClickEvent extends Event {
     ...
     * @since 1.0.0
     */
    public void currentItem(ItemStack currentItem) {
     ...
     * @since 1.0.0
     */
    public void currentItemDisplayName(String currentItemDisplayName) {
     ...
     * @since 1.1.1
     */
    public void slotType(InventoryType.SlotType slotType) {
