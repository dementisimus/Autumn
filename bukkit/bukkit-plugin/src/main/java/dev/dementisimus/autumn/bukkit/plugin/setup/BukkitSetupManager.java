...
package dev.dementisimus.autumn.bukkit.plugin.setup;

import dev.dementisimus.autumn.bukkit.plugin.setup.event.BukkitDeserializeSetupStateEvent;
import dev.dementisimus.autumn.bukkit.plugin.setup.event.BukkitNextExtraSetupStateEvent;
import dev.dementisimus.autumn.bukkit.plugin.setup.event.BukkitSerializeSetupStateEvent;
import dev.dementisimus.autumn.bukkit.plugin.setup.event.BukkitValidateCurrentExtraSetupStateEvent;
