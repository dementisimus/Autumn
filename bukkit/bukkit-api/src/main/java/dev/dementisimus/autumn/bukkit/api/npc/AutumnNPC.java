...
package dev.dementisimus.autumn.bukkit.api.npc;
...
public interface AutumnNPC {
    ...
    AutumnNPC translated(String translationKey, AutumnDoubleCallback<Player, AutumnBukkitTranslation> context);

    AutumnNPC translated(AutumnDoubleCallback<Player, AutumnBukkitTranslation> context);
    ...
    AutumnNPC onInteraction(AutumnDoubleCallback<Player, AutumnNPC.AutumnNPCInteractionAction> interaction);
