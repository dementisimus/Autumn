...
package dev.dementisimus.autumn.common.plugin;
...
import dev.dementisimus.autumn.common.plugin.configuration.CustomAutumnConfiguration;
import dev.dementisimus.autumn.common.plugin.dependency.CustomAutumnDependency;
import dev.dementisimus.autumn.common.plugin.dependency.CustomAutumnRepository;
import dev.dementisimus.autumn.common.plugin.file.CustomFileDownloader;
import dev.dementisimus.autumn.common.plugin.file.CustomZipFileDownloader;
import dev.dementisimus.autumn.common.plugin.i18n.CustomAutumnTranslation;
import dev.dementisimus.autumn.common.plugin.i18n.property.AutumnTranslationProperty;
import dev.dementisimus.autumn.common.plugin.injection.CustomAutumnInjector;
import dev.dementisimus.autumn.common.plugin.setup.CustomSetupManager;
import dev.dementisimus.autumn.common.plugin.setup.state.MainSetupStates;
import dev.dementisimus.autumn.common.plugin.setup.value.SetupValueManager;
import dev.dementisimus.autumn.common.plugin.storage.CustomStorage;
...
public abstract class CustomAutumn implements Autumn {
    ...
    private CustomAutumnInjector injector;
    @Getter(AccessLevel.PROTECTED)
    @Setter(AccessLevel.PROTECTED)
    private CustomSetupManager setupManager;
    ...
    @Setter(AccessLevel.PROTECTED)
    private ClassLoader autumnClassLoader;
    @Setter(AccessLevel.PROTECTED)
