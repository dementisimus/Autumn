...
package dev.dementisimus.autumn.plugin.setup.state.type;

import dev.dementisimus.autumn.api.storage.Storage;
import dev.dementisimus.autumn.plugin.helper.StringHelper;
import dev.dementisimus.autumn.plugin.setup.state.CustomSetupState;
