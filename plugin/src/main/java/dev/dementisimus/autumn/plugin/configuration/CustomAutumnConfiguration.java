...
package dev.dementisimus.autumn.plugin.configuration;
...
public class CustomAutumnConfiguration implements AutumnConfiguration {
    ...
    @Override
    public @NotNull AutumnConfiguration set(String key, Object object) {
        this.document.append(key, object);
        return this;
    }

    @Override
    public @NotNull AutumnConfiguration set(Document document) {
    ...
    @Override
    public @NotNull AutumnConfiguration set(String key, Number number) {
        this.document.append(key, number);
        return this;
    }

    @Override
    public @NotNull AutumnConfiguration set(String key, Boolean bool) {
        this.document.append(key, bool);
        return this;
    }

    @Override
    public @NotNull AutumnConfiguration set(String key, String string) {
        this.document.append(key, string);
        return this;
    }

    @Override
    public @NotNull AutumnConfiguration set(String key, Character character) {
        this.document.append(key, character);
        return this;
    }

    @Override
    public @NotNull AutumnConfiguration set(String key, Properties properties) {
        this.document.append(key, properties);
        return this;
    }

    @Override
    public @NotNull AutumnConfiguration set(String key, byte[] bytes) {
    ...
    @Override
    public void read(SingleCallback<@NotNull Document> callback) {
