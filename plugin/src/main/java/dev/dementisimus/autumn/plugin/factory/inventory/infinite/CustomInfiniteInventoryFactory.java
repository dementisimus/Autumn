...
package dev.dementisimus.autumn.plugin.factory.inventory.infinite;
...
import dev.dementisimus.autumn.api.factory.inventory.infinite.InfiniteInventoryFactory;
...
public class CustomInfiniteInventoryFactory implements InfiniteInventoryFactory {
    ...
    @Override
    public <T> void items(List<T> items, Class<T> clazz) {
    ...
    @Override
    public void create(AutumnTaskExecutor taskExecutor) {
    ...
    @Override
    public void create(AutumnTaskExecutor taskExecutor, Player openTo) {
        this.taskExecutor = taskExecutor;
