...
import dev.dementisimus.autumn.plugin.storage.property.CustomStorageProperty;
...
public class PlayerLanguage {
    ...
    public static void set(Storage storage, UUID uuid, Locale locale) {
        if (storage != null) {
            ...
            storage.property(CustomStorageProperty.of(AutumnLanguage.StorageSource.USER, uuid.toString()));
